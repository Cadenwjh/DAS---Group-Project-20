...
The main objective is to know **which factors influence the number of days an animal spends in the shelter before their final outcome is decided**. Beginning with data ingestion and cleaning, it converts categorical variables into factors for statistical modeling. Several visualizations, such as box plots, histograms, and bar charts, delineate the distributions and relationships between variables, highlighting the influence of animal types, chip status, intake and outcome types on the time spent in the shelter. Summary statistics provide a quantitative overview, while a correlation matrix delves into the relationships between numerical variables. Outlier treatment and variable filtering refine the dataset, leading to a linear model to ascertain the predictive power of these factors on shelter time, vital for enhancing animal welfare and shelter operations.
...
```{r}
#| echo: false
#| fig.cap: "the distribution of animal time in shelters"
#| label: fig-1
#| fig.align: 'center'
#| fig.width: 4
#| fig.height: 3
...
```{r}
#| echo: false
#| fig.cap: "Box plot of animal types and shelter time"
#| label: fig-2
#| fig.align: 'center'
#| fig.width: 4
#| fig.height: 3
...
```{r}
#| echo: false
#| fig.cap: "Box plot of whether to implant chips and shelter time"
#| label: fig-3
#| fig.align: 'center'
#| fig.width: 4
#| fig.height: 3
...
```{r}
#| echo: false
#| fig.cap: "Box plot of animal types and reasons for containment"
#| label: fig-4
#| fig.align: 'center'
#| fig.width: 4
#| fig.height: 3
...
```{r}
#| echo: false
#| fig.cap: "Box plot of animal types and the outcome of leaving the shelter"
#| label: fig-5
#| fig.align: 'center'
#| fig.width: 4
#| fig.height: 3
...
```{r}
#| echo: false
#| fig.cap: "Bar chart with chip status and containment reasons"
#| label: fig-6
#| fig.align: 'center'
#| fig.width: 4
#| fig.height: 3
...
```{r}
#| echo: false
#| fig.cap: "Bar chart with chip status and outcome of leaving the shelter"
#| label: fig-7
#| fig.align: 'center'
#| fig.width: 4
#| fig.height: 3
...
```{r}
#| echo: false
#| fig.cap: "Violin chart combined with bee colony chart, showing the impact of animal types on the time spent in shelters"
#| label: fig-8
#| fig.align: 'center'
#| fig.width: 4
#| fig.height: 3
...
```{r}
#| echo: false
#| fig.cap: "Violin chart combined with bee colony chart to demonstrate the impact of chip status on the time spent in the shelter"
#| label: fig-9
#| fig.align: 'center'
#| fig.width: 4
#| fig.height: 3
...
kable(correlation_matrix, caption = "correlation_matrix")
```
...
#VIF values
kable(vif_values, caption = "VIF values")
```
